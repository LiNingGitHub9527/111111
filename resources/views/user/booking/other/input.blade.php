        ...
        <div class="common_inputForm">
            <div class="common_inputItem">
                ...
                <select class="reservation_info_gender" name="{{ 'item_' . $item['id'] }}" data-required="{{ $item['is_required'] }}">
                    ...
                    <option value="1" @if(old( 'item_' . $item['id'],!empty($item['value'])?$item['value']:null)=='1') selected  @endif>男性</option>
                    <option value="2" @if(old( 'item_' . $item['id'],!empty($item['value'])?$item['value']:null)=='2') selected  @endif>女性</option>
                    <option value="3" @if(old( 'item_' . $item['id'],!empty($item['value'])?$item['value']:null)=='3') selected  @endif>その他</option>
                </select>
