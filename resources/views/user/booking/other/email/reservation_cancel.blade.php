...
<div class="mail_wrapper">
    <div class="main_inner">
        <div class="mail__common_attention_tx">
            <p>この度はご予約申請をしていただきありがとうございました。<br>
                誠に恐れ入りますが、下記のご予約は施設によりキャンセルされました。<br>
                またのご予約を心よりお待ちしております。
            </p>
        ...
        <div class="mail__base_content">
            ...
            <div class="mail__content_info">
                <p class="mail__content_info__strong">
                    利用料金／合計（税込） <span>￥ <?= number_format($amount) ?></span>
                </p>
                ...
                <div class="mail__detail_info">
                    <div class="mail__detail_info_block">
                        <p class="mail__detail_info__title">ご利用施設</p>
                    ...
                    <div class="mail__detail_info_block">
                        <p class="mail__detail_info__title">ご利用日</p>
                        <div class="mail__detail_info__flex">
                    ...
                    <div class="mail__detail_info_block">
                        <p class="mail__detail_info__title">ご利用のお部屋</p>
						<?php $i = 1;  ?>
						<?php foreach ($reservedRooms as $reservedRoom) { ?>
                        <p class="mail__detail_info__label"><?= $i ?>部屋目</p>
                        <div class="mail__detail_info__flex">
                            ...
                            <p class="mail__detail_info__right">￥ <?= number_format($reservedRoom->price) ?></p>
                        </div>
						<?php $i++; ?>
						<?php } ?>
                    </div>
